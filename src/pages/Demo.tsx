    ...
    <div style={{ background: '#050B14', minHeight: '100vh', color: '#E2E8F0' }}>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '40px 32px 80px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <h1 style={{ fontSize: 'clamp(1.75rem, 4vw, 2.5rem)', fontWeight: 900, color: '#E2E8F0', marginBottom: 10, lineHeight: 1.2, fontFamily: "var(--f-display)" }}>
      ...
      <div style={{ borderTop: '1px solid #1E2D3D' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', padding: '72px 32px', textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: 'clamp(1.75rem, 4vw, 2.5rem)', fontWeight: 900, color: '#E2E8F0', marginBottom: 12, lineHeight: 1.2, fontFamily: "var(--f-display)" }}>
