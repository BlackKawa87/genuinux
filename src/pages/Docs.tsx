...
function Section({ id, title, children }: { id: string; title: string; children: React.ReactNode }) {
  return (
    <section id={id} style={{ paddingBottom: 56, borderBottom: '1px solid #1E2D3D', marginBottom: 56 }}>
      <h2 style={{ fontFamily: "var(--f-display)", fontSize: 22, fontWeight: 700, color: '#F1F5F9', marginBottom: 20, display: 'flex', alignItems: 'center', gap: 10 }}>
      ...
      <div style={{ display: 'flex', maxWidth: 1200, margin: '0 auto' }}>
        ...
        <main style={{ flex: 1, minWidth: 0, padding: isMobile ? '24px 20px 60px' : '56px 60px 80px' }}>
          ...
          <div style={{ marginBottom: 56, paddingBottom: 32, borderBottom: '1px solid #1E2D3D' }}>
            ...
            <h1 style={{ fontFamily: "var(--f-display)", fontSize: 36, fontWeight: 800, color: '#F1F5F9', marginBottom: 12, lineHeight: 1.2 }}>
  ...
  "limit": 10000
          ...
          <Section id="best-practices" title="Best Practices">
            ...
            <div style={{ marginTop: 40, background: '#0B1220', border: '1px solid #16C78430', borderRadius: 10, padding: '24px 28px' }}>
              <div style={{ fontFamily: "var(--f-display)", fontWeight: 700, fontSize: 18, color: '#F1F5F9', marginBottom: 8 }}>
                Ready to integrate?
              </div>
